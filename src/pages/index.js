...
export default function Home() {
  ...
  const templates = [
    ...
    },
    {
      ...
      image: '/images/templates/dataeng.png'
    },
    {
      id: 'devops',
      nameKey: 'devOpsCV',
      descriptionKey: 'devOpsDesc',
      image: '/images/templates/devops.png'
    },
    {
      id: 'marketing',
      nameKey: 'marketingCV',
    ...
    <div className={`min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 transition-opacity duration-1000 ${animateIn ? 'opacity-100' : 'opacity-0'}`}>
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-blue-600 to-indigo-700 text-white">
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-b from-blue-500/20 to-indigo-600/20 bg-center"></div>
        </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <div className={`md:w-1/2 mt-10 md:mt-0 transition-all duration-1000 delay-300 transform ${animateIn ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              <div className="relative w-full h-80 md:h-96">
                <div className="absolute z-10 top-0 right-4 w-3/4 h-[calc(100%-40px)] shadow-xl rounded-lg transform rotate-3 border-4 border-white bg-gradient-to-br from-blue-200 to-indigo-300 flex items-center justify-center">
                  <div className="text-blue-800 font-bold text-xl">Resume Template</div>
                </div>
                <div className="absolute z-0 bottom-0 left-4 w-3/4 h-[calc(100%-40px)] shadow-xl rounded-lg transform -rotate-3 border-4 border-white bg-gradient-to-br from-indigo-300 to-blue-200 flex items-center justify-center">
                  <div className="text-blue-800 font-bold text-xl">CV Template</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/3 mb-8 md:mb-0">
              <div className="w-48 h-48 rounded-full overflow-hidden border-4 border-white mx-auto shadow-lg bg-blue-100 flex items-center justify-center">
                ...
                <Image
                  ...
                  width={192}
                  height={192}
                  className="w-full h-full object-cover rounded-full"></Image>
              </div>
            </div>
            <div className="md:w-2/3 md:pl-12">
              <h2 className="text-3xl font-bold mb-4">{t('aboutTitle') || 'About the Creator'}</h2>
              <p className="text-xl mb-6">
                {t('aboutDesc') || 'Hi, I\'m Nguyễn Thanh Nhân, the founder of CV Builder. With years of experience in professional resume creation, I designed this tool to help you create impressive CVs that stand out to employers.'}
              </p>
              <div className="flex space-x-4">
                <a href="https://github.com/uit-ntn" target="_blank" rel="noopener noreferrer" className="bg-white bg-opacity-20 hover:bg-opacity-30 rounded-full p-3 transition-colors">
                ...
                <a href="https://www.linkedin.com/in/nguyen-nhan-732a66247/" target="_blank" rel="noopener noreferrer" className="bg-white bg-opacity-20 hover:bg-opacity-30 rounded-full p-3 transition-colors">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" /></svg>
                </a>
                <a href="mailto:npthanhnhan2003@gmail.com" className="bg-white bg-opacity-20 hover:bg-opacity-30 rounded-full p-3 transition-colors">
